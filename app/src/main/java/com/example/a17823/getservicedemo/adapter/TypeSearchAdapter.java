...
public class TypeSearchAdapter extends RecyclerView.Adapter<TypeSearchAdapter.ViewHolder>{
    ...
    public TypeSearchAdapter(Activity mActivity, List<LoadallBean> bookBean){
        this.mActivity =mActivity;
        this. bookBean=bookBean;
    }
    @Override
    public TypeSearchAdapter.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
    ...
    @Override
    public void onBindViewHolder(final TypeSearchAdapter.ViewHolder holder, int position) {
    ...
    private void SetPic(TypeSearchAdapter.ViewHolder viewHolder,String path){
        if(path!=null){
